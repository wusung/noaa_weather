...
//        boolean eq = null==obj1? obj2.equals(obj1) : obj1.equals(obj2);
        boolean eq = isNull(obj1)? obj2.equals(obj1) : obj1.equals(obj2);
        return eq;
    }

	public static boolean isArchiveLatest(File archive, File latest) {
		return isArchiveLatest(archive, latest, false);
	}
	public static boolean isArchiveLatest(File archive, File latest, boolean test_md5) {
		...
		if (test_md5) {
			return CompareUtil.isEqual(EasyCodecUtil.md5(archive), EasyCodecUtil.md5(latest));	// test md5
		}
		return true;
	}
