 ...
 (function($){
	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		createLink:function(page_id, current_page, appendopts){
			...
			else
			{
				lnk = $("<a>" + appendopts.text + "</a>")
					...
					// buds add __page__  to 1+page_id
					.attr('href', this.opts.link_to.replace(/__id__/,page_id).replace(/__page__/,1+page_id));
			}
		...
		getLinks:function(current_page, eventHandler) {
			...
			// buds: Generate "Last"-Link
			if(this.opts.last_text && (current_page < np-1 || this.opts.last_show_always)){
				fragment.append(this.createLink(np, current_page, {text:this.opts.last_text, classes:"last",rel:"last"}));
			}
